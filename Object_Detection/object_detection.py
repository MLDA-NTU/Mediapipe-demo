...
efficient0 = "efficientdet_lite0.tflite"
efficient2 = "efficientdet_lite2.tflite"
mobilenet = "ssd_mobilenet_v2.tflite"
model_path = os.path.join(dir_path, efficient0)
...
while True:
    ...
    annotated = visualize(RGB, result) # Annotate
